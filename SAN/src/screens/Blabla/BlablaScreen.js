...
import ModelCard from '../Blabla/ModelCard';
import ListCard from '../Blabla/ListCard';
import AntDesign from 'react-native-vector-icons/AntDesign';


import LinearGradient from 'react-native-linear-gradient';

 const BlablaScreen = ({navigation}) => {
     ...
     return (
        ...
        colors={['#A7BFE8', '#D3CCE3']} style={styles.linearGradient}>
         <ImageBackground source={require('../image/Restaurants/Blabla/blabla5.jpg')}
