...
import ModelCard from '../Contra/ModelCard';
import ListCard from '../Contra/ListCard';
import AntDesign from 'react-native-vector-icons/AntDesign';


import LinearGradient from 'react-native-linear-gradient';

 const ContraScreen = ({navigation}) => {
     ...
     return (
        ...
        colors={['#A7BFE8', '#D3CCE3']} style={styles.linearGradient}>
         <ImageBackground source={require('../image/Restaurants/Contra/contra2.jpg')}
