...
import ModelCard from '../Metro/ModelCard';
import ListCard from '../Metro/ListCard';
import AntDesign from 'react-native-vector-icons/AntDesign';


import LinearGradient from 'react-native-linear-gradient';

 const MetroScreen = ({navigation}) => {
     ...
     return (
        ...
        colors={['#A7BFE8', '#D3CCE3']} style={styles.linearGradient}>
         <ImageBackground source={require('../image/shop/Metro/metro1.jpg')}
