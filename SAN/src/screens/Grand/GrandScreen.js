...
import ModelCard from '../Grand/ModelCard';
import ListCard from '../Grand/ListCard';
import AntDesign from 'react-native-vector-icons/AntDesign';


import LinearGradient from 'react-native-linear-gradient';

 const GrandScreen = ({navigation}) => {
     ...
     return (
        ...
        colors={['#A7BFE8', '#D3CCE3']} style={styles.linearGradient}>
         <ImageBackground source={require('../image/Restaurants/Grand/grand5.jpg')}
