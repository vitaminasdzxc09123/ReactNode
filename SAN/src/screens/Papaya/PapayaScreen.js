...
import ModelCard from '../Papaya/ModelCard';
import ListCard from '../Papaya/ListCard';
import AntDesign from 'react-native-vector-icons/AntDesign';


import LinearGradient from 'react-native-linear-gradient';

 const PapayaScreen = ({navigation}) => {
     ...
     return (
        ...
        colors={['#A7BFE8', '#D3CCE3']} style={styles.linearGradient}>
         <ImageBackground source={require('../image/shop/Papaya/papaya.jpg')}
